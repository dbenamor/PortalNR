<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Template.Master" AutoEventWireup="true" CodeBehind="NRsGeral.aspx.cs" Inherits="PortalNR.Relatorios.NRsGeral" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Relatório geral dos normativos</h2>
    <p>Consulta geral dos normativos.</p>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gridConsulta" CssClass="table table-striped table-hover" Font-Size="Small" GridLines="None" AutoGenerateColumns="false" AllowPaging="true" EnableModelValidation="True" OnPageIndexChanging="gridConsulta_PageIndexChanging" runat="server">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Situação NR">
